...
import org.ide.contentassist.antlr.internal.InternalAGESParser;
import org.services.AGESGrammarAccess;

public class AGESParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(AGESGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AGESGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalAGESParser createParser() {
		InternalAGESParser result = new InternalAGESParser(null);
